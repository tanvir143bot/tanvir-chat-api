        ...
        <center>
            ...
            <footer class="footer">
                <div id="music">
                    ...
                    <br>Thanks For Using <b>tanvir-chat-api</b> - From <b>Kanzu</b> <3<br>
                </div>
            </footer>
            </div>
        </center>
...
function setUserNameAndPassWord() {
    ...
    console.clear();
    console.log(figlet.textSync('TANVIR', {font: 'ANSI Shadow',TANVIRtalLayout: 'default',verticalLayout: 'default',width: 0,whitespaceBreak: true }));
    console.log(chalk.bold.hex('#00FF00')("[</>]") + chalk.bold.yellow(' => ') + "Operating System: " + chalk.bold.red(os.type()));
    console.log(chalk.bold.hex('#00FF00')("[</>]") + chalk.bold.yellow(' => ') + "Machine Version: " + chalk.bold.red(os.version()));
    console.log(chalk.bold.hex('#00FF00')("[</>]") + chalk.bold.yellow(' => ') + "Fca Version: " + chalk.bold.red(global.Fca.Version) + '\n');
    try {
